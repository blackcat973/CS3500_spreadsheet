...
// Change log:
// Last updated: 9/16/22 (Daniel Kopta), updated for non-nullable types
//               9/23/22 (SangYoon Cho), updated the comment of Visit method
...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        ///  
        /// It does recursion for searching indirected cells from name cell.
        /// When it moves to the other cell, store that cell into visited set, to escape searching again.
        /// When it finishes recursion, store the current cell to return list 
        /// which stores information about where does it follow the connection (directly or indirectly)
        /// </summary>
        /// <param name="start"> starting cell for searching </param>
        /// <param name="name"> the starting point </param>
        /// <param name="visited"> visited cell list to escape searching route duplication </param>
        /// <param name="changed"> directed or indirected cell list </param>
